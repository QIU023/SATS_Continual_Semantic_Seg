    ...
    "25-25":
        {
            ...
            2: list(range(51, 76)),
            3: list(range(76, 101)),
            4: list(range(101, 126)),
            5: list(range(126, 151))
        },
    "10-10":
        {
            0:[x for x in range(0, 11)],
            1:[x for x in range(11, 21)],
            2:[x for x in range(21, 31)],
            3:[x for x in range(31, 41)],
            4:[x for x in range(41, 51)],
            5:[x for x in range(51, 61)],
            6:[x for x in range(61, 71)],
            7:[x for x in range(71, 81)],
            8:[x for x in range(81, 91)],
            9:[x for x in range(91, 101)],
            10:[x for x in range(101, 111)],
            11:[x for x in range(111, 121)],
            12:[x for x in range(121, 131)],
            13:[x for x in range(131, 141)],
            14:[x for x in range(141, 151)],
        }
}
...
def get_per_task_dict(dataset, name):
    if dataset == 'voc':
        task_dict = tasks_voc[name]
    elif dataset == 'ade':
        task_dict = tasks_ade[name]
