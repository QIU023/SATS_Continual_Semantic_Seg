...
# CUDA_VISIBLE_DEVICES=${GPU} python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=${NB_GPU} run.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 0 --lr 0.01 --epochs ${INITIAL_EPOCHS} --method ${METHOD} --opt_level O1 ${OPTIONS} --model 'segformer_b2' --ckpt checkpoints/step/10-1-voc_PLOP_0_segformer_b2.pth
...
# CUDA_VISIBLE_DEVICES=${GPU} python3 -m torch.distributed.launch --master_port ${PORT} --nproc_per_node=${NB_GPU} run.py --date ${START_DATE} --data_root ${DATA_ROOT} --overlap --batch_size ${BATCH_SIZE} --dataset ${DATASET} --name ${NAME} --task ${TASK} --step 10 --lr 0.001 --epochs 30 --method ${METHOD} --opt_level O1 ${OPTIONS} --model 'segformer_b2'


# python3 average_csv.py ${RESULTSFILE}

rm checkpoints/step/10-1-voc_PLOP_1_segformer_b2.pth
rm checkpoints/step/10-1-voc_PLOP_2_segformer_b2.pth
rm checkpoints/step/10-1-voc_PLOP_3_segformer_b2.pth
rm checkpoints/step/10-1-voc_PLOP_4_segformer_b2.pth
rm checkpoints/step/10-1-voc_PLOP_5_segformer_b2.pth
...
# rm 10-1-voc_PLOP_1_segformer_b2.pth
# rm 10-1-voc_PLOP_2_segformer_b2.pth
# rm 10-1-voc_PLOP_3_segformer_b2.pth
# rm 10-1-voc_PLOP_4_segformer_b2.pth
# rm 10-1-voc_PLOP_5_segformer_b2.pth
# rm 10-1-voc_PLOP_6_segformer_b2.pth
# rm 10-1-voc_PLOP_7_segformer_b2.pth
# rm 10-1-voc_PLOP_8_segformer_b2.pth
# rm 10-1-voc_PLOP_8_segformer_b2.pth
# rm 10-1-voc_PLOP_9_segformer_b2.pth
